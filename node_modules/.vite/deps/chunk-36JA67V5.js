...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(React12.Fragment, {
    children: React12.cloneElement(children2, childrenProps)
  });
}
...
var Portal = React27.forwardRef(function Portal2(props, ref) {
  ...
  const handleRef = useForkRef(React27.isValidElement(children2) ? children2.ref : null, ref);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
function getOptionsFromChildren(children2) {
  ...
  React36.Children.forEach(children2, (node2) => {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-36JA67V5.js.map
